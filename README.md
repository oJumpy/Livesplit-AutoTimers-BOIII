...
1. If you are using BOIII Client, you need to use a specific version of it. [BOIII Community v1.0.0](https://github.com/oJumpy/Livesplit-AutoTimers-BOIII/releases/download/v2.2/boiii.exe) 
